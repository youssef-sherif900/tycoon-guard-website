...
const slides = [
  {
    title: "تايكون جارد",
    subtitle: "الأفضل في مجال الأمن والحراسة",
    description:
      "تايكون جارد لخدمات الأمن والحراسة وإدارة المشاريع. تأسست الشركة على يد فريق متخصص من الخبراء الأمنيين وذوي الخلفية العسكرية.",
