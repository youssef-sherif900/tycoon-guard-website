...
const services = [
  {
    ...
    href: "/security-and-guarding-company",
  },
  {
    icon: Briefcase,
    ...
    href: "/private-guarding-services-egypt",
  },
  {
    icon: Camera,
    ...
    href: "/supply-of-surveillance-cameras",
  },
]
...
const additionalServices = [
  ...
  },
  {
    ...
    href: "/security-and-guarding-companies",
  },
  {
    title: "أمن المدارس والجامعات",
    description: "حماية المنشآت التعليمية والطلاب بأعلى معايير السلامة",
    href: "/school-security",
  },
  {
    title: "تقييم المخاطر",
    description: "تحليل شامل للمخاطر الأمنية وتقديم حلول استباقية",
    href: "/security-services-prices",
  },
]
              ...
              <div className={index % 2 === 1 ? "lg:order-1" : ""}>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Button asChild size="lg" variant="outline" className="rounded-full px-8 border-primary/20">
                    <Link href={service.href}>تفاصيل أكثر</Link>
                  </Button>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {additionalServices.map((service, index) => (
                <Link key={index} href={service.href} className="block group">
                  <Card className="border-none bg-gray-50 group-hover:bg-gray-100 transition-all h-full">
